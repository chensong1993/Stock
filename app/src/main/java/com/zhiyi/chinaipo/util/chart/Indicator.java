package com.zhiyi.chinaipo.util.Chart;
...
//        Log.d("DEBUG", "curPoint y= "+curPoint.y+"curPoint x= "+curPoint.x);
        double up = calculateSquare(mCenterPoint, curPoint) + calculateSquare(mCenterPoint, mLastPoint) -
                calculateSquare(curPoint, mLastPoint);
        ...
        double cos=dir* Math.acos(up/down)*180/ Math.PI;
